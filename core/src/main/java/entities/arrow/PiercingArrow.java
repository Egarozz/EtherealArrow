...
public class PiercingArrow extends Arrow{
	
	public PiercingArrow(Vector2 position, Vector2 direction, FirstScreen sc) {
		super(Arrows.Piercing,position.cpy(), direction.cpy(), new Sprite(new Texture("Arrow.png")), sc);
